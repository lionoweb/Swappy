  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid"> 
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php" title="Retour à l'accueil"><img width="127" height="47" src="img/logonav.png" alt="" class="max"><img alt="" width="50" height="47" src="img/logo_min.png" class="min"></a> <span class="brand-title">A propos</span> </div>
  ...
  <div id="spec_apropos" class="container-fluid main" role="main">
    ...
    <div id="spec_team" class="container team">
      <ul class="row list_view">
        <li class="view view-sixth"> <img src="img/apropos/calypso.png" alt="Calypso Redor" width="225" height="225">
          <div class="mask">
            <h2>Calypso Redor</h2>
            ...
            <a data-hash="<?php echo encode_mail("calypso.redor@swappy.fr", "UTF"); ?>" class="more link_mail">Contactez-la</a> </div>
        </li>
        <li class="view view-sixth"> <img src="img/apropos/lionel.png" alt="Lionel Jeronimo" width="225" height="225">
          <div class="mask">
            ...
            <a data-hash="<?php echo encode_mail("lionel.jeronimo@swappy.fr", "UTF"); ?>" class="more link_mail">Contactez-le</a> </div>
        </li>
        <li class="view view-sixth"> <img src="img/apropos/oceane.png" alt="Océane Perret" width="225" height="225">
          <div class="mask">
            <h2>Océane Perret</h2>
            <p>Intégratrice et développeuse, elle est sérieuse et impliquée. Elle est toujours disponible avec des idées novatrices.</p>
            <a data-hash="<?php echo encode_mail("oceane.perret@swappy.fr", "UTF"); ?>" class="more link_mail">Contactez-la</a> </div>
        </li>
      </ul>
      <ul class="row list_view">
        <li class="view view-sixth"> <img src="img/apropos/line.png" alt="Line Bui" width="225" height="225">
          <div class="mask">
            <h2>Line Bui</h2>
            <p> Intégratrice et développeuse. Elle est motivée et prête à passer des heures sur un problème pour le résoudre.</p>
            <a data-hash="<?php echo encode_mail("line.bui@swappy.fr", "UTF"); ?>" class="more link_mail">Contactez-la</a> </div>
        </li>
        <li class="view view-sixth"> <img src="img/apropos/brice.png" alt="Brice Olivrie" width="225" height="225">
          <div class="mask">
            <h2>Brice Olivrie</h2>
            ...
            <a data-hash="<?php echo encode_mail("mailto:brice.olivrie@swappy.fr", "UTF"); ?>" class="more link_mail">Contactez-le</a> </div>
        </li>
        <li class="view view-sixth"> <img src="img/apropos/margot.png" alt="Margot Gillodes" width="225" height="225">
          <div class="mask">
