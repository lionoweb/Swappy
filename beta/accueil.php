           ...
           <div class="carousel-inner" role="listbox">
             <div class="item active">
               <img src="img/slide1.jpg" alt="...">
                  <h1 class="carousel-title">Une plateforme</h1>
<!--                <div class="carousel-caption">
                 ...
               </div> -->
            </div>
            <div class="item">
               <img src="img/slide_avatar.png" alt="...">
               <h1 class="carousel-title">Une Communauté</h1>
<!--                <div class="carousel-caption">
                 ...
               </div> -->
            </div>
            <div class="item">
               <img src="..." alt="...">
                  <h1 class="carousel-title">Une équipe</h1>
<!--                <div class="carousel-caption">
                 ...
               </div> -->
             </div>
