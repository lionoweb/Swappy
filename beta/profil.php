            ...
            <div class="header_profil">
               <div class="row">
                  <div class="top col-lg-4 col-lg-offset-3 col-md-4 col-md-offset-3">
                     <img src="img/user/M.jpg" class="col-lg-4 col-md-6 col-sm-3">
                     <p class="text-left col-lg-8 col-md-8 col-sm-8 nom">John Doe</p>
                     <p class="text-left col-lg-8 col-md-8">29 ans<span><img src="img/profil/location.png" alt="">Perpignan</span></p>
